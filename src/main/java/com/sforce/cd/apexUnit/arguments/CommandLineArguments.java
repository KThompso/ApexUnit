...
public class CommandLineArguments {
	...
	public static final String TRUE_REGEX_FOR_SELECTING_TEST_CLASSES_TO_EXECUTE = "-true.regex.for.selecting.test.classes.to.execute";
	public static final String TRUE_REGEX_FOR_SELECTING_SOURCE_CLASSES_FOR_CODE_COVERAGE_COMPUTATION = "-true.regex.for.selecting.source.classes.for.code.coverage.computation";
	...
	@Parameter(names = TRUE_REGEX_FOR_SELECTING_TEST_CLASSES_TO_EXECUTE, description = "The true test regex used by the team for the apex test classes. "
			+ "All tests beginning with this parameter in the org will be selected to run", variableArity = true)
	...
	@Parameter(names = TRUE_REGEX_FOR_SELECTING_SOURCE_CLASSES_FOR_CODE_COVERAGE_COMPUTATION, description = "The true source regex used by the team for the apex source classes. "
			+ "All classes beginning with this parameter in the org will be used to compute team code coverage", variableArity = true)
